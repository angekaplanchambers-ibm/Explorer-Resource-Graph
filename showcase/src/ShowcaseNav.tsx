...
import type { CssLength, ShowcaseSection, PreambleNavItem } from './types';
...
export function ShowcaseNav({ sections, activeId, preambleNav, width }: ShowcaseNavProps) {
  return (
    <nav style={{ ...navContainer, width: width ?? navContainer.width }} aria-label="Showcase navigation">
      <ul style={listStyle}>
