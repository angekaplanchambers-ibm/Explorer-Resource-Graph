import svgPaths from "./svg-ye87aelh8m";
...
function Link5() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0" data-name="link">
      <p className="[word-break:break-word] font-['SF_Pro:Medium',sans-serif] font-[510] leading-[16px] relative shrink-0 text-[#656a76] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>{`Types & Use cases`}</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <div className="relative shrink-0 size-[16px]" data-name="Type Icon">
        <div className="absolute inset-[6.25%]" data-name="Path">
          <svg className="absolute block inset-0 size-full" fill="none" height="14" preserveAspectRatio="none" viewBox="0 0 14 14" width="14">
            <path clipRule="evenodd" d={svgPaths.p2cb44f80} fill="#8C909C" fillRule="evenodd" id="Path" />
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] font-['SF_Pro:Medium',sans-serif] font-[510] leading-[18px] relative shrink-0 text-[#3b3d45] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        Workspaces
      </p>
    </div>
  );
...
function SelectBy() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Select by">
      <Frame />
    </div>
  );
}
...
function Value() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="Value">
...
function Id() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="ID">
      <p className="[word-break:break-word] font-['SF_Pro:Medium',sans-serif] font-[510] leading-[16px] relative shrink-0 text-[#656a76] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        ID:
      </p>
      <Value />
...
function Metadata() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0" data-name="Metadata">
      <SelectBy />
      <Id />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col h-full isolate items-start overflow-clip relative shrink-0 w-[48px]" data-name="selection">
      <div className="shrink-0 sticky top-0 z-[21]" data-name="AdvancedTable::Header::Selection">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative size-full">
            <div className="h-[48px] relative rounded-tl-[6px] shrink-0" data-name="Selection Header">
              <div aria-hidden className="absolute bg-[#f1f2f3] inset-0 pointer-events-none rounded-tl-[6px]" />
  ...
  return (
    <div className="h-full relative shrink-0 w-[237px]" data-name="column-1">
      <div className="content-stretch flex flex-col isolate items-start overflow-clip relative rounded-[inherit] size-full">
        <div className="shrink-0 sticky top-0 w-full z-[21]" data-name="AdvancedTable::HeaderColumn::Base">
          <div aria-hidden className="absolute bg-[#f1f2f3] inset-0 pointer-events-none" />
        ...
        <div className="relative shrink-0 w-full z-[20]" data-name="AdvancedTable::Cell::Base">
        ...
        <div className="relative shrink-0 w-full z-[19]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[18]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[17]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[16]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[15]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[14]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[13]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[12]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[11]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[10]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[9]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[8]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[7]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[6]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[5]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[4]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[3]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[2]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
        ...
        <div className="relative shrink-0 w-full z-[1]" data-name="AdvancedTable::Cell::Base">
          <div aria-hidden className="absolute bg-white inset-0 pointer-events-none" />
          <div aria-hidden className="absolute border-[rgba(101,106,118,0.2)] border-b border-l border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative size-full">
...
function Column23() {
  return (
    <div className="content-stretch flex flex-col h-full isolate items-start overflow-clip relative shrink-0 w-[200px]" data-name="column-08">
      <div className="rounded-tr-[6px] shrink-0 sticky top-0 w-full z-[21]" data-name="AdvancedTable::HeaderColumn::Base">
        <div aria-hidden className="absolute bg-[#f1f2f3] inset-0 pointer-events-none rounded-tr-[6px]" />
...
function BigTable() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[2672px]" data-name="big-table">
      <Columns />
    </div>
  );
}
...
function ExplorerTable() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-x-auto overflow-y-clip relative shrink-0 w-full" data-name="explorer table">
      <BigTable />
      <div className="flex h-[15px] items-center justify-center relative shrink-0 w-[2672px]">
        <div className="-rotate-90 flex-none">
          <div className="h-[2672px] relative rounded-tl-[5px] w-[15px]" data-name="scroll">
...
function Contents17() {
  return (
    <div className="content-stretch flex flex-col items-start px-[2px] py-[3px] relative shrink-0" data-name="contents">
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Content">
      <div className="relative shrink-0 size-[16px]" data-name="◇ Icon">
        <div className="absolute inset-[6.25%]" data-name="Path">
          <svg className="absolute block inset-0 size-full" fill="none" height="14" preserveAspectRatio="none" viewBox="0 0 14 14" width="14">
            <path clipRule="evenodd" d={svgPaths.p2cb44f80} fill="#1060FF" fillRule="evenodd" id="Path" />
          </svg>
        </div>
      </div>
      <div className="[word-break:break-word] flex flex-col font-['SF_Pro:Medium',sans-serif] font-[510] justify-center leading-[0] relative shrink-0 text-[#1060ff] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function AppSideNav() {
  return (
    <div className="absolute bg-[#fafafa] content-stretch flex h-[1198px] items-start justify-end left-0 top-0 w-[280px]" data-name="AppSideNav">
      <Body1 />
...
function Body() {
  return (
    <div className="h-[1200px] relative shrink-0 w-[1400px]" data-name="Body">
      <MainContent />
      <AppSideNav />
    </div>
  );
...
export default function Workspaces() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(101,106,118,0.05),0px_2px_1px_rgba(101,106,118,0.05)] flex flex-col items-start relative rounded-[20px] size-full" data-name="Workspaces">
