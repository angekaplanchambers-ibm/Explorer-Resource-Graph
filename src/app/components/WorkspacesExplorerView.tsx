...
useEffect(() => {
  ...
  return (
    <div className="relative h-full min-h-[640px] min-w-[1200px] overflow-hidden bg-[#fafafa] font-sans" style={{ color: glassText }}>
      ...
      {/* Compact Explorer context HUD — always mounted, slides in/out via transform */}
      <div
        className="absolute z-30"
        style={{
          left: hudPosition.x,
          top: hudPosition.y,
          transform: hudCollapsed ? "translateX(calc(-100% - 36px))" : "translateX(0)",
          transition: "transform 0.3s cubic-bezier(0.25,0.8,0.25,1)",
        }}
      >
        {/* Expand/collapse tab — always visible, sticks to outside-right of the HUD card */}
        <button
          type="button"
